...
(defvar pov-begin-re
  "\\<#\\(if\\(n?def\\)?\\|for\\|case\\|macro\\|range\\|switch\\|while\\)\\>")
    ...
    (concat "\\<\\("
	    (regexp-opt '("aa_level" "aa_threshold" "abs" "absorption"
			  ...
			  "fog_type" "fopen" "for" "form"
                          "frame_number" "frequency" "fresnel"
                          "function" "gamma" "gather"
			  ...
			  "sqrt" "srgb" "srgbf" "srgbft" "srgbt"
                          "statistics" "str" "strcmp"
  ...
  (eval-when-compile
    (concat "\\<\\("
	    (regexp-opt '("background" "bicubic_patch" "blob" "box"
			  ...
			  "ovus" "parametric" "plane" "poly"
			  "polygon" "prism" "rainbow" "sky_sphere"
...
(defvar pov-light-source-keywords
  '("color" "spotlight" "point_at" "radius" "falloff" "tightness"
    ...
    "media_interaction" "rgb" "srgb" "circular" "orient" "groups" "parallel"))
